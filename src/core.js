...
function remainingBakeTime(timeRemain) {
  return bakingTime() - timeRemain
}
...
function totalTimeSpent(cakeLayers, cakeInOven) {
  const bakingCake =
    bakingTime() -
    remainingBakeTime(cakeInOven) +
    calculatePreparationTime(cakeLayers)
  return bakingCake
}
